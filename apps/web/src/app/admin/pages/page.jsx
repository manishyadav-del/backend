                  ...
                  {paginatedPages.map(page => (
                    <tr key={page.id} style={{ borderBottom: '1px solid var(--border-light)', transition: 'background-color 0.2s' }}>
                      <td style={{ padding: '1rem 1.5rem', fontWeight: 600 }}>
                        <Link href={`/admin/pages/${page.id}`} style={{ color: 'var(--text-primary)', textDecoration: 'none' }} className="hover-underline">
                          {page.title}
                        </Link>
                      </td>
                      ...
                      <td style={{ padding: '1rem 1.5rem', textAlign: 'right' }}>
                        <div style={{ display: 'inline-flex', gap: '0.5rem' }}>
                          <Link href={`/admin/pages/${page.id}`} className={`${styles.actionBtn} ${styles.actionBtnEdit}`} title="Edit in builder">
                            ✏️
                          </Link>
                          <Link href={`/admin/pages/${page.id}/edit`} className={`${styles.actionBtn}`} title="Page Settings">
                            ⚙️
                          </Link>
