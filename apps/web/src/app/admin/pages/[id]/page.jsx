      ...
      <div className="pb-main">
        ...
        <aside className="pb-sidebar-left">
          <div className="pb-sidebar-head">
            ...
            <button className="pb-btn-add" onClick={() => { setInsertAfterIndex(null); setShowSectionLibrary(true); }}>+ Add</button>
          </div>
          <div className="pb-sections-list" onDragOver={e => e.preventDefault()}>
            {activeSections.length === 0 && (
              <div className="pb-sections-empty">
                <span>🧩</span>
                <p>No sections yet</p>
                <button onClick={() => setShowSectionLibrary(true)} className="pb-btn-add">Add First Section</button>
              </div>
            )}
            {activeSections.map((sec, idx) => (
              ...
              >
                ...
                <div className="pb-section-actions">
                  <button onClick={e => { e.stopPropagation(); setInsertAfterIndex(idx); setShowSectionLibrary(true); }} className="pb-action-btn" title="Insert after">+</button>
