  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        // Role-based redirect
        const redirectUrl = data.redirectUrl === '/admin' || data.redirectUrl === '/home' || !data.redirectUrl ? '/admin/dashboard' : data.redirectUrl;
        ...
        {!show2FA ? (
          <form onSubmit={handleLogin}>
            ...
            <p style={{ textAlign: 'center', marginTop: '1rem', fontSize: '0.875rem', color: 'var(--text-secondary)' }}>
              Don't have an account? <a href="/admin/register" className="forgot-link">Register here</a>
            </p>
