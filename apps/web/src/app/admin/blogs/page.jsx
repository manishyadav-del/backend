              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  >
                    ...
                    {Array.from(new Set(blogs.map(b => b.category).filter(Boolean))).map((cat, idx) => (
                ...
                <div style={{
                  ...
                  {availablePages.length === 0 ? (
                    ...
                    availablePages.map(p => {
                      ...
                      return (
                        <label key={p.id} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.85rem', cursor: 'pointer', color: '#000000' }}>
                          <input
                            type="checkbox"
                            checked={isChecked}
                            onChange={(e) => {
