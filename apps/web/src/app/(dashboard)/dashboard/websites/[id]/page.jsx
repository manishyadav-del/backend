  ...
  if (!website) {
    return (
      <div style={{ textAlign: 'center', padding: '4rem' }}>
        ...
        <Link href="/dashboard/websites" className="btn-secondary" style={{ marginTop: '1rem', display: 'inline-block' }}>Back to Connections</Link>
      </div>
    );
  }
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
        <Link href="/dashboard/websites" style={{ fontSize: '0.85rem', color: 'var(--primary)', fontWeight: 'bold' }}>← Back to Websites</Link>
        <span style={{
          display: 'inline-flex',
          alignItems: 'center',
          gap: '0.35rem',
